...
public class UsuarioControlador implements Serializable{
  ...
  private Usuario actual;
    ...
    public List<Usuario> getListasusuario() {
           if (listausuario==null) {
            listausuario=getFacade().findAll();
        }
        return listausuario;
    }
    ...
    public String prepararVista(){
        actual =(Usuario)getItems().getRowData();
    ...
    public String crear(){
        try {
            ...
            JsfUtil.agregarMensajeExito("Usuario Creado");
            return prepararCrear();
        } catch (Exception e) {
            JsfUtil.agregarMensageDeError(e,"ERROR al Crear Usuario");
            return null;
        }
    }
    ...
    public String editar(){
        try {
            ...
            JsfUtil.agregarMensajeExito("Usuario Actualizado");
            return "vista";
        } catch (Exception e) {
            JsfUtil.agregarMensageDeError(e,"ERROR al editar Usuario");
            return null;
        }
    }
    ...
    private void realizarBorrado(){
        try {
            ...
            JsfUtil.agregarMensajeExito("Usuario Borrado");
        } catch (Exception e) {
            JsfUtil.agregarMensageDeError(e,"Error al borrar Usuario");
        }
    }
    ...
    public static class UsuariocontroladorConversor implements Converter{
        @Override
        public Object getAsObject(
           ...
           UsuarioControlador controlador = (UsuarioControlador) facescontext.
                   getApplication().
                   getELResolver().
                   getValue(
                           facescontext.getELContext(), 
                           null, "usuarioControlador"
                   );
